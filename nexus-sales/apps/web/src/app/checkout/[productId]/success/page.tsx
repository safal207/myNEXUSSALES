...
export default function CheckoutSuccessPage() {
  ...
  useEffect(() => {
    track('upsell_view', { productId, orderId });
  }, [productId, orderId]);

  const handleUpsellClick = () => {
    track('upsell_click', { productId, orderId, upsellProductId: 'upsell-prod-123' });
    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="w-full max-w-lg p-8 text-center bg-white rounded-xl shadow-lg">
        ...
        <div className="mt-8 p-6 border-t border-dashed">
          ...
          <p className="mt-2 text-gray-600">Add our exclusive "Advanced Techniques" guide to your order for just $19.99!</p>
          <button
